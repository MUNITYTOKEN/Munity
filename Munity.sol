...
contract Munity is IERC20 {
    ...
    address private _taxMarketingWallet;
    address private _taxLPWallet;
    address private _taxFundWallet;
    address private _deadWallet = address(0x000000000000000000000000000000000000dEaD); // Dead wallet address
    ...
    uint256 private _uniswapStartTime;
    uint256 private constant _numTokensSellToAddToLiquidity = 50000 * (10**9); // 50,000 tokens with 9 decimal places
    uint256 private constant _numSecondsDelay = 1 minutes;
    uint256 private constant _maxTxAmount = 10000 * (10**9); // 10,000 tokens with 9 decimal places
...
function setMaxTxAmount(uint256 maxTxAmount) external onlyOwner {
    require(maxTxAmount > 0, "Invalid maximum transaction amount");
